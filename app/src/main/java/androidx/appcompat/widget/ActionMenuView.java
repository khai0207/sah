...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
        ...
        if (z2) {
            for (int i33 = 0; i33 < childCount; i33++) {
                ...
                if (layoutParams5.expanded) {
                    childAt4.measure(View.MeasureSpec.makeMeasureSpec((layoutParams5.cellsUsed * i11) + layoutParams5.extraPixels, WXVideoFileObject.FILE_SIZE_LIMIT), childMeasureSpec);
                }
            }
        }
    ...
    static int measureChildForCells(View view, int i, int i2, int i3, int i4) {
        ...
        view.measure(View.MeasureSpec.makeMeasureSpec(i * i5, WXVideoFileObject.FILE_SIZE_LIMIT), makeMeasureSpec);
        return i5;
    }
