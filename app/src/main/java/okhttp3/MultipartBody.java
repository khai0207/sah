...
public final class MultipartBody extends RequestBody {
    ...
    public static final MediaType FORM = MediaType.parse(FastHttp.MULTIPART_FROM_DATA);
    private static final byte[] COLONSPACE = {58, 32};
    private static final byte[] CRLF = {df.k, 10};
    ...
    public static final class Part {
        ...
        public static Part createFormData(String str, String str2, RequestBody requestBody) {
            ...
            return create(Headers.of(com.netease.nimlib.amazonaws.services.s3.Headers.CONTENT_DISPOSITION, sb.toString()), requestBody);
        }
