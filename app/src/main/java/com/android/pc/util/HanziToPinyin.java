...
public class HanziToPinyin {
    ...
    private void spellPut(String str, int i) {
        spellMap.put(str, new Integer(i));
    }
    ...
    private void initialize() {
        ...
        spellPut(b.k, -14914);
        spellPut("pai", -14908);
        spellPut(Constant.KEY_PAN, -14902);
        spellPut("pang", -14894);
        spellPut("pao", -14889);
        spellPut("pei", -14882);
        spellPut("pen", -14873);
        ...
        spellPut("piao", -14674);
        spellPut("pie", -14670);
        spellPut(Constant.KEY_PIN, -14668);
        spellPut("ping", -14663);
        spellPut("po", -14654);
        spellPut("pu", -14645);
        spellPut("qi", -14630);
    ...
    private int getCnAscii(char c) {
        ...
        return (((bArr[0] + df.a) * 256) + (bArr[1] + df.a)) - 65536;
    }

    private String getSpellByAscii(int i) {
        if (i > 0 && i < 160) {
