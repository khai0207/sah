    ...
    public static b a(String str) {
        try {
            if (!com.alipay.sdk.m.u.a.a(str)) {
                ...
                return new b(jSONObject.optString("apdid"), jSONObject.optString("deviceInfoHash"), jSONObject.optString(com.alipay.sdk.m.p.a.k));
            }
        } catch (Exception e) {
    ...
    public static synchronized void a(Context context, b bVar) {
        synchronized (a.class) {
            try {
                ...
                jSONObject.put(com.alipay.sdk.m.p.a.k, bVar.c);
