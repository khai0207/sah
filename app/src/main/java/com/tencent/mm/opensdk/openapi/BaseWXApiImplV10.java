...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        if (queryParameter.equals("subscribemessage")) {
            ...
            String queryParameter2 = parse.getQueryParameter(SpeechUtility.TAG_RESOURCE_RET);
            ...
            resp.scene = b.a(parse.getQueryParameter(TextUnderstanderAidl.SCENE), 0);
        ...
        if (queryParameter.contains("invoice_auth_insert")) {
            ...
            String queryParameter3 = parse.getQueryParameter(SpeechUtility.TAG_RESOURCE_RET);
        ...
        if (queryParameter.contains("payinsurance")) {
            ...
            String queryParameter4 = parse.getQueryParameter(SpeechUtility.TAG_RESOURCE_RET);
        ...
        if (queryParameter.contains("nontaxpay")) {
            ...
            String queryParameter5 = parse.getQueryParameter(SpeechUtility.TAG_RESOURCE_RET);
        ...
        String queryParameter6 = parse.getQueryParameter(SpeechUtility.TAG_RESOURCE_RET);
                    ...
                    if (str != null && str.contains("openbusinesswebview")) {
                        try {
                            ...
                            if (parse != null && "openbusinesswebview".equals(parse.getHost())) {
                                ...
                                String queryParameter = parse.getQueryParameter(SpeechUtility.TAG_RESOURCE_RET);
    ...
    public boolean registerApp(String str, long j) {
        ...
        c0063a.a = "com.tencent.mm";
        c0063a.b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0063a.c = "weixin://registerapp?appid=" + this.appId;
        c0063a.d = j;
        return a.a(this.context, c0063a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C0063a c0063a = new a.C0063a();
        c0063a.a = "com.tencent.mm";
        c0063a.b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0063a.c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0063a);
    }
}
