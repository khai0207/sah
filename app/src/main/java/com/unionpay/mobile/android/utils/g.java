...
public final class g {
    ...
    private static final int[] d = {R.attr.state_enabled, R.attr.state_pressed};
    private static final int[] e = {R.attr.state_enabled, R.attr.state_focused};
    private static final int[] f = {R.attr.state_enabled, R.attr.state_checked};
    ...
    public static ColorStateList a(int i, int i2, int i3, int i4) {
        return new ColorStateList(new int[][]{new int[]{R.attr.state_pressed, R.attr.state_enabled}, new int[]{R.attr.state_enabled, R.attr.state_focused}, new int[]{R.attr.state_enabled}, new int[]{R.attr.state_focused}, new int[]{R.attr.state_window_focused}, new int[0]}, new int[]{i2, i3, i, i3, i4, i4});
    }
