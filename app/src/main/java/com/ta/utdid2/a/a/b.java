...
public class b {
    ...
    /* loaded from: classes.dex */
    public static class C0062b extends a {
    ...
    public static byte[] decode(byte[] bArr, int i, int i2, int i3) {
        C0062b c0062b = new C0062b(i3, new byte[(i2 * 3) / 4]);
        if (c0062b.a(bArr, i, i2, true)) {
            int i4 = ((a) c0062b).a;
            byte[] bArr2 = ((a) c0062b).f0a;
            if (i4 == bArr2.length) {
                return bArr2;
            }
