...
public class YXArtemisIcmpIpv6 extends b {
    private int count;
    ...
    public native String pingIcmpIpv6(String str, int i);

    public YXArtemisIcmpIpv6(String str, String str2, String str3, int i, JSONObject jSONObject, String str4, String str5, int i2, String str6, Context context, String str7, YXArtemisRunTaskCallback yXArtemisRunTaskCallback) {
    ...
    @Override // com.netease.yunxin.artemis.Artemis.b
    public void taskRun() {
        this.mResult = pingIcmpIpv6(this.hostname, this.count);
    }
}
