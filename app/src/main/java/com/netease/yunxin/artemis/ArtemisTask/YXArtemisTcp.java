...
public class YXArtemisTcp extends b {
    private int count;
    ...
    public native String tcpPing(String str, int i, int i2);

    public YXArtemisTcp(String str, String str2, String str3, int i, JSONObject jSONObject, String str4, String str5, int i2, String str6, Context context, String str7, YXArtemisRunTaskCallback yXArtemisRunTaskCallback) {
    ...
    @Override // com.netease.yunxin.artemis.Artemis.b
    public void taskRun() {
        this.mResult = tcpPing(this.hostname, Integer.parseInt(this.port), this.count);
    }
}
