...
public class ProgressListenerCallbackExecutor {
    ...
    public static Future<?> progressChanged(final ProgressListener progressListener, final ProgressEvent progressEvent) {
        ...
        return executor.submit(new Runnable() { // from class: com.netease.nimlib.amazonaws.event.ProgressListenerCallbackExecutor.1
    ...
    public void progressChanged(final ProgressEvent progressEvent) {
        ...
        executor.submit(new Runnable() { // from class: com.netease.nimlib.amazonaws.event.ProgressListenerCallbackExecutor.2
            @Override // java.lang.Runnable
            public void run() {
    ...
    static ExecutorService createNewExecutorService() {
        return Executors.newSingleThreadExecutor(new ThreadFactory() { // from class: com.netease.nimlib.amazonaws.event.ProgressListenerCallbackExecutor.3
