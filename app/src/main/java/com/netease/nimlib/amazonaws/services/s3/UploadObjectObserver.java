...
import com.netease.nimlib.amazonaws.services.s3.internal.PartCreationEvent;
...
public class UploadObjectObserver {
    ...
    public void onPartCreate(PartCreationEvent partCreationEvent) {
        ...
        this.futures.add(this.es.submit(new Callable<UploadPartResult>() { // from class: com.netease.nimlib.amazonaws.services.s3.UploadObjectObserver.1
