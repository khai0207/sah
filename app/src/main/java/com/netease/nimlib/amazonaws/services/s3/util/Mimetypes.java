package com.netease.nimlib.amazonaws.services.s3.util;
...
public final class Mimetypes {
    ...
    Mimetypes() {
        ...
        this.extensionToMimetypeMap.put(ThreeMap.type, "application/x-troff");
    ...
    public String getMimetype(String str) {
        ...
        if (lastIndexOf > 0 && (i = lastIndexOf + 1) < str.length()) {
            ...
            if (log.isDebugEnabled()) {
                log.debug("Extension '" + lowerCase + "' is unrecognized in mime type listing, using default mime type: '" + MIMETYPE_OCTET_STREAM + "'");
            }
        } else if (log.isDebugEnabled()) {
