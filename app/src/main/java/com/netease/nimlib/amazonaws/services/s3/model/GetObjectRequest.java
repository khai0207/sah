...
public class GetObjectRequest extends AmazonWebServiceRequest implements SSECustomerKeyProvider, Serializable {
    private com.netease.nimlib.amazonaws.event.ProgressListener generalProgressListener;
    ...
    public ProgressListener getProgressListener() {
        com.netease.nimlib.amazonaws.event.ProgressListener progressListener = this.generalProgressListener;
    ...
    @Override // com.netease.nimlib.amazonaws.AmazonWebServiceRequest
    public void setGeneralProgressListener(com.netease.nimlib.amazonaws.event.ProgressListener progressListener) {
        this.generalProgressListener = progressListener;
    }

    @Override // com.netease.nimlib.amazonaws.AmazonWebServiceRequest
    public com.netease.nimlib.amazonaws.event.ProgressListener getGeneralProgressListener() {
        return this.generalProgressListener;
    }

    @Override // com.netease.nimlib.amazonaws.AmazonWebServiceRequest
    public GetObjectRequest withGeneralProgressListener(com.netease.nimlib.amazonaws.event.ProgressListener progressListener) {
    ...
    @Override // com.netease.nimlib.amazonaws.services.s3.model.SSECustomerKeyProvider
