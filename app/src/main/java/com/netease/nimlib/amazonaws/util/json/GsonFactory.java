package com.netease.nimlib.amazonaws.util.json;
...
final class GsonFactory implements AwsJsonFactory {
    ...
    @Override // com.netease.nimlib.amazonaws.util.json.AwsJsonFactory
    ...
    private static final class GsonReader implements AwsJsonReader {
        ...
        @Override // com.netease.nimlib.amazonaws.util.json.AwsJsonReader
    ...
    /* renamed from: com.netease.nimlib.amazonaws.util.json.GsonFactory$1, reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    private static final class GsonWriter implements AwsJsonWriter {
        ...
        @Override // com.netease.nimlib.amazonaws.util.json.AwsJsonWriter
