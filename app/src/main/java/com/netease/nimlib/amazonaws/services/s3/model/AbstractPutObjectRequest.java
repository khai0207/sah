...
public abstract class AbstractPutObjectRequest extends AmazonWebServiceRequest implements S3DataSource, SSEAwsKeyManagementParamsProvider, SSECustomerKeyProvider, Serializable {
    ...
    @Override // com.netease.nimlib.amazonaws.services.s3.model.S3DataSource
    public File getFile() {
        return this.file;
    }
    ...
    public ProgressListener getProgressListener() {
        com.netease.nimlib.amazonaws.event.ProgressListener generalProgressListener = getGeneralProgressListener();
    ...
    @Override // com.netease.nimlib.amazonaws.services.s3.model.SSEAwsKeyManagementParamsProvider
