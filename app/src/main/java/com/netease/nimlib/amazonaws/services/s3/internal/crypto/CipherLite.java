...
class CipherLite {
    static final CipherLite NULL = new CipherLite() { // from class: com.netease.nimlib.amazonaws.services.s3.internal.crypto.CipherLite.1
        @Override // com.netease.nimlib.amazonaws.services.s3.internal.crypto.CipherLite
