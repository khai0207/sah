...
import com.netease.nimlib.amazonaws.services.s3.internal.crypto.CryptoRuntime;
...
public class CryptoConfiguration implements Serializable, Cloneable {
    ...
    private transient com.netease.nimlib.amazonaws.regions.Region awskmsRegion;
    ...
    private static final class ReadOnly extends CryptoConfiguration {
        @Override // com.netease.nimlib.amazonaws.services.s3.model.CryptoConfiguration
        public boolean isReadOnly() {
            return true;
        }
    ...
    public Regions getKmsRegion() {
        com.netease.nimlib.amazonaws.regions.Region region = this.awskmsRegion;
        if (region == null) {
            return null;
        }
    ...
    public void setKmsRegion(Regions regions) {
        if (regions != null) {
            setAwsKmsRegion(com.netease.nimlib.amazonaws.regions.Region.getRegion(regions));
        } else {
    ...
    public com.netease.nimlib.amazonaws.regions.Region getAwsKmsRegion() {
        return this.awskmsRegion;
    }

    public void setAwsKmsRegion(com.netease.nimlib.amazonaws.regions.Region region) {
        this.awskmsRegion = region;
    }

    public CryptoConfiguration withAwsKmsRegion(com.netease.nimlib.amazonaws.regions.Region region) {
        this.awskmsRegion = region;
        return this;
    }
}
